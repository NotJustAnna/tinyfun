package net.notjustanna.tinyfun.server;

import jakarta.servlet.Servlet;
import net.notjustanna.tinyfun.manager.FunManager;
import net.notjustanna.tinyfun.server.servlet.FunServlet;
import net.notjustanna.tinyfun.server.servlet.FunsServlet;
